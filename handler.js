...
global.dfail = (type, m, conn) => {
    let msg = {
        rowner: '*هذا الأمر خاص بصاحب البوت فقط و لن يشتغل معك هذا الأمر ',
        owner: '*هذا الأمر خاص بصاحب البوت فقط و لن يشتغل معك هذا الأمر  \n this cmd is just for owner bot',
        ...
        admin: '*معذرة يا صديقي لكن هذا الأمر بأدمين هذه المجموعة *',
        botAdmin: '*[ ⚠ تنبيه ⚠ ] لتتمكن من استخدام هذا الأمر، يجب أن يكون البوت مسؤولاً،اومشرفا على المجموعة قم برفع هذا الرقم كمسؤول*',
    ...
    let prep = generateWAMessageFromContent(m.chat, { extendedTextMessage: { text: msg, contextInfo: { externalAdReply: { title: 'Follow me here : ', body: '﮼♪ﺑوﺕ|الصاعـ|ـقة⁞¹²', thumbnail: imagen1, sourceUrl: '' }}}}, aa)
